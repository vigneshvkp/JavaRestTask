! function(a, b, c, d) {
    ...
    function o(a, b, c, d) {
        function e(e) {
            function f(b) {
                k = b;
                var e = d.newDTInstance(l),
                    f = c.hideLoadingAndRenderDataTable(b, l.options);
        ...
        function h(h) {
            ...
            function n(b, c) {
                ...
                return t = d.isFunction(b) ? b() : b, t.then(function(a) {
                    var b = a;
                    if (u.options.sAjaxDataProp)
                        for (var d = u.options.sAjaxDataProp.split("."); d.length;) {
                            var f = d.shift();
                            f in b && (b = b[f])
                        }
