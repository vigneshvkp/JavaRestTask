! function(a, b) {
    ...
    */
    ...
    angular.module("textAngularSetup", []).constant("taRegisterTool", c).value("taTools", e).value("taOptions", {
        ...
        defaultFileDropHandler: /* istanbul ignore next: untestable image processing */ function(a, b) {
            ...
            link: function(f, u, v, w) {
                ...
                var W = function(a) {
                    ...
                    //value = value.replace(/<br>/i, '');
                        a = "<" + v.taDefaultWrap + ">" + a + "</" + v.taDefaultWrap + ">";
                    else {
                ...
                if (
                    ...
                    if (f.events = {}, E) {
                                ...
                                if (a && a.trim().length) {
                                    ...
                                    if (a.match(/class=["']*Mso(Normal|List)/i) || a.match(/content=["']*Word.Document/i) || a.match(/content=["']*OneNote.File/i)) {
                                        ...
                                        if (
                                            ...
                                            a = a.replace(/<(|\/)(html|body|meta)[^>]*?>/ig, '').trim(), a.match(/<[^>]*?(ta-bind)[^>]*?>/)) {
                        ...
                        u.on("paste", f.events.paste = function(b, e) {
                            ...
                            d.find("body").append(k), c(function() {
                                // restore selection
                            	   console.log('COPIED DATA',k)
